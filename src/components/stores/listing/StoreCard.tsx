      ...
      <div className="p-2 sm:p-4 space-y-2 sm:space-y-4">
        ...
        <div className="space-y-1 sm:space-y-2">
          <div className="flex items-start justify-between">
            <h3 className="text-base sm:text-xl font-semibold text-light-900 truncate">
              {store.storeName}
            </h3>
            {store.settings.isVerified && (
              <span className="bg-gold-primary/10 text-gold-primary text-xs px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full">
                Verified
              </span>
            )}
          </div>
          <p className="text-xs sm:text-sm text-light-600 line-clamp-2">
            {store.description}
          </p>
        </div>
        ...
        {/* Store Info */}
        <div className="space-y-1 sm:space-y-2">
          <div className="flex items-center text-xs sm:text-sm text-light-600">
            <svg
        ...
        {/* Store Metrics */}
        <div className="flex justify-between pt-2 sm:pt-4 border-t border-gold-primary/10 text-xs sm:text-sm">
